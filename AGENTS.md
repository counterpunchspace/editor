...
- Run command line arguments such that the user can see the output, don't route the output into unreadable pipelines and don't run commands in the background because you can’t check exit codes that way.
