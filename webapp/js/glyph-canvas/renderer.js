class GlyphCanvasRenderer {
     ...
     */
    constructor(canvas, glyphCanvas, viewportManager, textRunEditor) {
        this.canvas = canvas;
    ...
    drawShapedGlyphs() {
        ...
        this.textRunEditor.shapedGlyphs.forEach((glyph, glyphIndex) => {
            ...
            const isHovered = glyphIndex === this.glyphCanvas.hoveredGlyphIndex;
            const isSelected =
    ...
    drawGlyphTooltip() {
        ...
        if (
            ...
            const glyphBounds =
                this.glyphBounds[this.glyphCanvas.hoveredGlyphIndex];
    ...
    drawOutlineEditor() {
        ...
        if (
            ...
            if (
                ...
                this.glyphCanvas.layerData.shapes.forEach((shape) => {
        ...
        if (
            ...
            this.glyphCanvas.layerData.shapes.forEach((shape, contourIndex) => {
                console.log(
                    '[GlyphCanvas]',
                    'Drawing shape',
                    contourIndex,
                ...
                shape.nodes.forEach((node, nodeIndex) => {
                    ...
                    const isHovered =
                        ...
                        this.glyphCanvas.hoveredPointIndex.contourIndex ===
                            contourIndex &&
            ...
            // Draw components
            this.glyphCanvas.layerData.shapes.forEach((shape, index) => {
                if (!shape.Component) {
        ...
        if (
            ...
            this.glyphCanvas.layerData.anchors.forEach((anchor, index) => {
